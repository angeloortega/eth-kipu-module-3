...
contract PataCoinStakingContract is Initializable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _stakingToken, uint256 _rewardRate, address initialOwner) external initializer {
    ...
    function claimReward() external nonReentrant {
        ...
        require(stakingToken.balanceOf(address(this)) >= reward, "Insufficient treasury balance");
    ...
    function updateReward(address _staker) internal {
        ...
        if (userStake.lastUpdated > 0) {
            ...
            uint256 reward = userStake.amount * rewardRate / BASIS_POINTS * duration / SECONDS_IN_A_YEAR;
